...
void protobuf_AddDesc_person_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014person.proto\022\002pb\"\316\001\n\006Person\022\014\n\004name\030\001 "
    "\002(\t\022\n\n\002id\030\002 \002(\005\022\r\n\005email\030\003 \001(\t\022%\n\005phone\030"
    "\004 \003(\0132\026.pb.Person.PhoneNumber\032G\n\013PhoneNu"
    "mber\022\016\n\006number\030\001 \002(\t\022(\n\004type\030\002 \001(\0162\024.pb."
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::pb::Person_PhoneType_IsValid(value)) {
            set_type(static_cast< ::pb::Person_PhoneType >(value));
          } else {
